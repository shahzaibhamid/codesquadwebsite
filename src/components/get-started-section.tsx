    ...
    <section className="relative pt-0 pb-24 md:pb-32 overflow-hidden">
      ...
      <div className="relative z-10 max-w-5xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="relative rounded-3xl overflow-hidden">
          ...
          <div className="relative z-10 text-center px-8 sm:px-12 md:px-16 py-14 md:py-16">
            <div className="inline-flex items-center gap-2 px-4 py-1.5 rounded-full bg-white/[0.07] border border-white/[0.1] mb-3">
            ...
            <p className="text-base sm:text-lg text-blue-100/45 max-w-2xl mx-auto mb-5 leading-relaxed">
              We Serve:
            </p>
            ...
            <p className="mt-5 text-base text-blue-100/60">
