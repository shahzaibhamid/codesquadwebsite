...
export default function CaseStudyMockup({ eyebrow, title, stats, rows, accent = '#4a90d9' }: CaseStudyMockupProps) {
  return (
    <div className="cs-mockup" style={{ ['--cs-mockup-accent' as string]: accent }}>
